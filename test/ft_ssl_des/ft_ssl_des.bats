...
@test "echo -n \"=\" | base64 -d" {
    run bats_pipe echo -n "=" \| ../ft_ssl base64 -d
    assert_output "$(echo -n "=" | base64 -d)"
}

@test "echo -n \"Z\" | base64 -d" {
    run bats_pipe echo -n "Z" \| ../ft_ssl base64 -d
...
@test "echo -n \"Zg\" | base64 -d" {
    run bats_pipe echo -n "Zg" \| ../ft_ssl base64 -d
...
@test "echo -n \"Zg=a\" | base64 -d" {
    run bats_pipe echo -n "Zg=a" \| ../ft_ssl base64 -d
    assert_output "$(echo -n "Zg=a" | base64 -d)"
}

@test "echo -n \"Zm8\" | base64 -d" {
    run bats_pipe echo -n "Zm8" \| ../ft_ssl base64 -d
